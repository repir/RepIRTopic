 ...
 * @author jeroen
 */
public class AOIP2RetrievalModel extends RetrievalModelExpander {

   public static Log log = new Log(AOIP2RetrievalModel.class);

   public AOIP2RetrievalModel(Retriever retriever) {
      super(retriever);
   }
   ...
   public String getQueryToRetrieve() {
      ...
      for (String t : query.stemmedquery.split("\\s+")) {
         ...
         if (sense != null) {
            ...
            sb.append(" ").append(GraphRoot.reformulate(TermAOIP2.class, t));
         } else {
            sb.append(" ").append( t );
         }
      }

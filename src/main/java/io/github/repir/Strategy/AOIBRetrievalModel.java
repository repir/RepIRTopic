 ...
 * @author jeroen
 */
public class AOIBRetrievalModel extends RetrievalModelExpander {

   public static Log log = new Log(AOIBRetrievalModel.class);

   public AOIBRetrievalModel(Retriever retriever) {
      super(retriever);
   }
   ...
   public String getQueryToRetrieve() {
      ...
      for (String t : query.stemmedquery.split("\\s+")) {
         ...
         if (sense != null) {
            ...
            sb.append(" ").append(GraphRoot.reformulate(TermAOIB.class, t));
         } else {
            sb.append(" ").append( t );
         }
      }

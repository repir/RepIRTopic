 ...
 * @author jeroen
 */
public class AOIQRetrievalModel extends RetrievalModelExpander {

   public static Log log = new Log(AOIQRetrievalModel.class);

   public AOIQRetrievalModel(Retriever retriever) {
      super(retriever);
   }
   ...
   public String getQueryToRetrieve() {
      ...
      for (String t : query.stemmedquery.split("\\s+")) {
         ...
         if (sense != null) {
            ...
            sb.append(" ").append(GraphRoot.reformulate(TermAOIQ.class, t));
         } else {
            sb.append(" ").append( t );
         }
      }

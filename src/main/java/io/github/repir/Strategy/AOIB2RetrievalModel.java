 ...
 * @author jeroen
 */
public class AOIB2RetrievalModel extends RetrievalModelExpander {

   public static Log log = new Log(AOIB2RetrievalModel.class);

   public AOIB2RetrievalModel(Retriever retriever) {
      super(retriever);
   }
   ...
   public String getQueryToRetrieve() {
      ...
      for (String t : query.stemmedquery.split("\\s+")) {
         ...
         if (sense != null) {
            ...
            sb.append(" ").append(GraphRoot.reformulate(TermAOIB2.class, t));
         } else {
            sb.append(" ").append( t );
         }
      }

 ...
 * @author jeroen
 */
public class AOIBDRetrievalModel extends RetrievalModelExpander {

   public static Log log = new Log(AOIBDRetrievalModel.class);

   public AOIBDRetrievalModel(Retriever retriever) {
      super(retriever);
   }
   ...
   public String getQueryToRetrieve() {
      ...
      for (String t : query.stemmedquery.split("\\s+")) {
         ...
         if (sense != null) {
            ...
            sb.append(" ").append(GraphRoot.reformulate(TermAOIBD.class, t));
         } else {
            sb.append(" ").append( t );
         }
      }

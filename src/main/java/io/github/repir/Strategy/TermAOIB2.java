 ...
 * @author jeroen
 */
public class TermAOIB2 extends Term {

   public static Log log = new Log(TermAOIB2.class);
   ...
   public TermAOIB2(GraphRoot root, String originalterm, String stemmedterm) {
      super(root, originalterm, stemmedterm);
      alpha = repository.getConfigurationDouble("aoi.alpha", 1.0);
   }

   public TermAOIB2(GraphRoot im, ArrayList<Term> list) {
   ...
   public GraphNode clone(GraphRoot newmodel) {
      if (termid >= 0) {
         TermAOIB2 e = new TermAOIB2(newmodel, originalterm, stemmedterm);
         return e;
      } else {
         return null;
      }

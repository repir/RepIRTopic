...
import RBM.RBM2.RBMparameterset;
 ...
 * @author jeroen
 */
public class RBMupdater2 {

   public static Log log = new Log(RBMupdater2.class);
   RBM2 rbm;                   // the RBM that is being learned

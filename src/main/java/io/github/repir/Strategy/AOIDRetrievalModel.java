 ...
 * @author jeroen
 */
public class AOIDRetrievalModel extends RetrievalModelExpander {

   public static Log log = new Log(AOIDRetrievalModel.class);

   public AOIDRetrievalModel(Retriever retriever) {
      super(retriever);
   }
   ...
   public String getQueryToRetrieve() {
      ...
      for (String t : query.stemmedquery.split("\\s+")) {
         ...
         if (sense != null) {
            ...
            sb.append(" ").append(GraphRoot.reformulate(TermAOID.class, t));
         } else {
            sb.append(" ").append( t );
         }
      }
